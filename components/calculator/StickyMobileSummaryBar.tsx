...
export function StickyMobileSummaryBar({ result }: StickyMobileSummaryBarProps) {
  ...
  return (
    <div
      className={`fixed inset-x-0 bottom-0 z-50 border-t-2 pb-[env(safe-area-inset-bottom)] shadow-[0_-2px_12px_rgba(0,0,0,0.1)] md:hidden ${getRiskBarTintClasses(result.risk.colorToken)}`}
    >
